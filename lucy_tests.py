...
class LucyTests(unittest.TestCase):
    ...
    def testThatTheBlackPAwnMovesForward1Or2Steps(self):
        ...
        valid_moves = self.cb.getValidMoves((1, 6))
        assert  valid_moves[0] == (1, 5)
        assert  valid_moves[1] == (1, 4)

    def testBlackFirstMove(self):
        valid_moves = self.cb.getValidMoves((4, 6)) # The first black pawn
    ...
    def testWhiteFirstMove(self):
        ...
        valid_moves = self.cb.getValidMoves((5, 1)) # The first white pawn
        assert valid_moves[0] == (5, 2)
        assert valid_moves[1] == (5, 3)

    def test4eCanEat5f(self):
        self.cb.addTextMove('e2e4')
        self.cb.addTextMove('f7f5')
        valid_moves = self.cb.getValidMoves((4, 4)) # The black
    ...
    def testWhiteSecondMove(self):
        self.cb.addTextMove('e2e4')
        self.cb.addTextMove('f7f5')
        self.cb.addTextMove('e4f5')
        valid_moves = self.cb.getValidMoves((6, 0)) # The white
    ...
    def testBlackThirdMove(self):
        ...
        self.cb.addTextMove('f7f5')
        self.cb.addTextMove('e4f5')
        self.cb.addTextMove('g8h6')
        valid_moves = self.cb.getValidMoves((5, 7)) # The black
    ...
    def testWhiteFourthMove(self):
        ...
        self.cb.addTextMove('e4f5')
        self.cb.addTextMove('g8h6')
        self.cb.addTextMove('f1d3')
        valid_moves = self.cb.getValidMoves((7, 2)) # The white
    ...
    def testBlackFourthMove(self):
        ...
        self.cb.addTextMove('g8h6')
        self.cb.addTextMove('f1d3')
        self.cb.addTextMove(('h6f5'))
        valid_moves = self.cb.getValidMoves((3, 5)) # The black
        assert valid_moves[0] == (4, 6)
